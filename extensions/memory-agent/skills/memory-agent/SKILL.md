...
位置：`homes/{currentAgentId}/memory/entries/{category}/{YYYY-MM}.md`
...
Read homes/{currentAgentId}/memory/index/preference.md
```
...
- 使用 `Grep` 工具搜索关键词
- 示例：`Grep pattern="文件系统" path="homes/{currentAgentId}/memory/index/preference.md"`
...
```typescript
Read homes/{currentAgentId}/memory/entries/preference/2026-03.md
```
...
2. 读取 `homes/{currentAgentId}/memory/index/preference.md`
3. 扫描找到匹配关键词"数据库"的记忆
4. 读取对应的内容文件
