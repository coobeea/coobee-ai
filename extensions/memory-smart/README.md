...
LLM 判断相关分类
    ↓
Read 索引文件 (index/{category}.md)
    ↓
扫描/Grep 找到相关记忆 ID
    ↓
Read 详细内容 (entries/{category}/{month}.md)
    ↓
整合记忆，回答用户
```
