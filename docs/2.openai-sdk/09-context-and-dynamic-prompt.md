...
function customInstructions(runContext: RunContext<CustomContext>, _agent: Agent<CustomContext>): string {
...
```typescript
type InstructionsFn<TContext> = (runContext: RunContext<TContext>, agent: Agent<TContext>) => string | Promise<string>;
```
