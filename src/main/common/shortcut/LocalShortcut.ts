...
export function register(
  ...
  log.debug(`[LocalShortcut] 注册快捷键 ${accelerator} (窗口: ${getWindowTitle(winOrAccelerator as BrowserWindow)})`);
...
export function isRegistered(winOrAccelerator: BrowserWindow | string, accelerator?: string): boolean {
  let wc: WebContents | typeof ANY_WINDOW;
  let finalAccelerator: string;
