...
export const searchTool: ToolDefinition = {
  ...
  parameters: z.object({
    pattern: z
      .string()
      .describe('Search pattern. Supports regex syntax (e.g. "function\\s+\\w+", "TODO|FIXME")'),
    searchPath: z
      .string()
      .optional()
      .describe(
    ...
    glob: z
      .string()
      .optional()
      .describe('File name filter glob (e.g. "*.ts", "*.{ts,tsx}", "package.json")'),
    caseSensitive: z
      .boolean()
      .optional()
      .describe('Case-sensitive search. Defaults to false (case-insensitive).'),
    maxResults: z
      .number()
      .optional()
      .describe(`Maximum total matches to return. Defaults to ${DEFAULT_MAX_RESULTS}`)
  }),
