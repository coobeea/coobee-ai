...
describe('SessionMemoryStore', () => {
  ...
  it('getHistory 返回全部历史', async () => {
    messages.push({ role: 'user', content: 'a', timestamp: 1 }, { role: 'assistant', content: 'b', timestamp: 2 });
  ...
  it('getStats 返回统计', async () => {
    messages.push({ role: 'user', content: 'u', timestamp: 100 }, { role: 'assistant', content: 'a', timestamp: 200 });
